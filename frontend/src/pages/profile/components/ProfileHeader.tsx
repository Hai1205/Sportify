            ...
            <div className="flex gap-2 justify-center md:justify-start mb-4">
              {currentUser.website && (
                <a
                  ...
                  className="bg-zinc-800 hover:bg-green-600 p-2 rounded-full transition-colors"
                >
              ...
              {currentUser.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-zinc-800 hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-600 p-2 rounded-full transition-colors"
                >
              ...
              {currentUser.twitter && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-zinc-800 hover:bg-sky-500 p-2 rounded-full transition-colors"
                >
