...
export const getMessages = async (myId: string, _opponentId: string, page: number = 1, limit: number = 20): Promise<any> => {
    return await axiosInstance.get(`/api/chats/conversations/${myId}/messages/`, {
        params: { page, limit }
    });
}
