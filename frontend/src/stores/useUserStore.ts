...
interface UserStore {
    ...
    responseUpdateUserToArtist: (applicationId: string, formData: FormData) => Promise<any>;
...
export const useUserStore = create<UserStore>()(
    persist(
        (set) => ({
            ...
            responseUpdateUserToArtist: async (applicationId, formData: FormData) => {
                set({ error: null });

                try {
                    const response = await responseUpdateUserToArtist(applicationId, formData);
