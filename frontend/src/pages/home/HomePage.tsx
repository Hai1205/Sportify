  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setFeaturedSongs(Array.isArray(featured) ? featured : []);
        setMadeForYouSongs(Array.isArray(madeForYou) ? madeForYou : []);
        setTrendingSongs(Array.isArray(trending) ? trending : []);
